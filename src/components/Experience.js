      ...
      <div className='body-container'>
        ...
        <div className='experience-wrapper'>
          ...
          <div class="experience-container left">
              <div class="content">
                <h5 className='project-title'>Tesco myProduct:Develop</h5>
                <div className='project-title'>Xebia / Tesco, Bangalore </div>
                <div className='project-title'>Frontend Team Lead</div>
                <div className='project-time'>Mar 2019 - Till Date</div>
                <p className='project-details'>Web application to manage new products in TESCO stores</p>
